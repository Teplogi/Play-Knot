    ...
    <header className="sticky top-0 z-30 bg-white border-b border-gray-200 shadow-sm">
      ...
      <div className="flex items-center justify-between px-4 sm:px-6 h-14 max-w-5xl mx-auto">
        ...
        <button
          type="button"
          onClick={signOut}
          className="flex-shrink-0 inline-flex items-center gap-1 px-3 h-9 -mr-2 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-100 active:bg-gray-200"
          aria-label="ログアウト"
        >
