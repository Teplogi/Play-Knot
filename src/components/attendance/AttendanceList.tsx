...
export function AttendanceList({ attendances, totalMembers }: AttendanceListProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      {tentative.length > 0 && (
        <div>
          <h4 className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">検討中</h4>
          <div className="space-y-1.5">
            {tentative.map((a) => (
              <div key={a.id} className="flex items-center gap-3 bg-amber-50/40 rounded-lg px-3 py-2">
